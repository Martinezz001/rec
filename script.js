...
// Aqui, estou definindo uma função chamada toggleMode que será usada para alternar entre os modos de luz e escuro.
function toggleMode() {
    // Seleciono o elemento HTML raiz.
    let html = document.documentElement;
    // Adiciono ou removo a classe 'light' no elemento HTML para alternar entre os modos.
    html.classList.toggle('light');
}

// Estou selecionando todos os elementos com a classe 'like-btn' e armazenando-os na variável 'cotonete'.
var cotonete = document.querySelectorAll(".like-btn");

// Agora, estou iterando sobre cada elemento da lista 'cotonete' usando um forEach.
cotonete.forEach((value) => {
    // Adiciono um evento de clique a cada elemento.
    value.addEventListener("click", () => {
        // Dentro do evento de clique, adiciono ou removo a classe 'liked' para alternar o estado de "curtido" ou "não curtido".
